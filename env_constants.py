...
elif hostname == 'hjp-Z690-AERO-G' : # 3090 X 1
    # conda env : gamrnetcode
    PYGARMENT_ROOT  = "E:/HJP/KUAICV/VTO/REFERENCES/GarmentCodeAnalysis"
    DATASET_ROOT    = "E:/HJP/KUAICV/VTO/DATA/PoC"
